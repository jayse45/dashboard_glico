...
const TransactionsFilterPage = () => {
  ...
  const table6Columns = React.useMemo(() => {
    ...
    return [
      table6ColumnHelper.accessor("rowrectangletwo", {
        cell: (info) => (
      ...
      table6ColumnHelper.accessor("plan", {
        cell: (info) => (
      ...
      table6ColumnHelper.accessor("beneficiary", {
        cell: (info) => (
      ...
      table6ColumnHelper.accessor("amount", {
        cell: (info) => (
          <Text
        ...
        <div className="flex flex-col gap-8 items-center justify-start max-w-[1420px] mb-[43px] mx-auto md:px-5 w-full">
          ...
          <div className="flex md:flex-col flex-row md:gap-5 items-start justify-evenly w-full">
            ...
            <div className="bg-white-A700 border border-indigo-50 border-solid flex md:flex-1 flex-col items-center justify-start p-[18px] rounded-[16px] w-[84%] md:w-full">
              <div className="flex flex-col items-start justify-start mb-[116px] mt-[25px] w-full">
                ...
                <div className="flex flex-row gap-[9px] items-start justify-start mt-5 w-auto">
                  <Button
                    className="border border-indigo-50 border-solid cursor-pointer flex items-center justify-center min-w-[118px]"
                    rightIcon={
                      <Img
                        className="h-4 mt-px mb-0.5"
                    ...
                    variant="fill"
                  >
                    <div className="font-medium text-[15px] text-left tracking-[0.15px]">
                      Jan - Aug
                    </div>
                  </Button>
                  <Button
                    className="border border-indigo-50 border-solid cursor-pointer flex items-center justify-center min-w-[161px]"
                    rightIcon={
                      <Img
                        className="h-4 mt-0.5 mb-px"
                        src="images/img_close.svg"
                        alt="close"
                      />
                    }
                ...
                <div className="overflow-auto mt-[26px] w-full">
                  <ReactTable
...
export default TransactionsFilterPage;
