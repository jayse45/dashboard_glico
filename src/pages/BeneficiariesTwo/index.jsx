...
const fatherOptionsList = [
  { label: "Option1", value: "option1" },
  { label: "Option2", value: "option2" },
  { label: "Option3", value: "option3" },
];
const ghanaOptionsList = [
  { label: "Option1", value: "option1" },
  { label: "Option2", value: "option2" },
  { label: "Option3", value: "option3" },
];

const BeneficiariesTwoPage = () => {
  ...
  const table9Columns = React.useMemo(() => {
    ...
    return [
      table9ColumnHelper.accessor("rowrectangletwo", {
        cell: (info) => (
      ...
      table9ColumnHelper.accessor("address", {
        cell: (info) => (
          <Text
      ...
      table9ColumnHelper.accessor("contact", {
        cell: (info) => (
          <Text
      ...
      table9ColumnHelper.accessor("dateadded", {
        cell: (info) => (
          <Text
            className="pl-1 py-7 text-[15px] text-blue_gray-700 tracking-[0.15px]"
            size="txtMontserratMedium15Bluegray700"
      ...
      table9ColumnHelper.accessor("age", {
        cell: (info) => (
      ...
      table9ColumnHelper.accessor("action", {
        cell: (info) => (
          ...
          <div className="border border-blue_gray-50_01 border-solid flex flex-col items-start justify-start rounded-[12px] w-auto">
            ...
            <div className="bg-white-A700 flex flex-col gap-5 items-start justify-start max-w-[647px] sm:px-5 px-8 py-5 w-full">
              <div className="flex flex-col gap-3 items-start justify-start w-full">
                ...
                <Input
                  ...
                  className="!placeholder:text-blue_gray-900_01 !text-blue_gray-900_01 font-semibold md:h-auto p-0 sm:h-auto text-[15px] text-left w-full"
              ...
              <div className="flex flex-col gap-3 items-start justify-start w-full">
                ...
                <SelectBox
                  className="!text-blue_gray-900_01 font-semibold h-12 rounded-[12px] text-[15px] text-left w-full"
            ...
            <div className="bg-white-A700 flex flex-col gap-5 items-start justify-start max-w-[647px] sm:px-5 px-8 py-5 w-full">
              <div className="md:h-20 h-[82px] relative w-full">
                ...
                <div className="absolute md:h-[43px] h-[82px] inset-y-[0] my-auto right-[0] w-full">
                  <div className="absolute bg-white-A700 flex flex-1 flex-col h-max inset-[0] items-center justify-end m-auto w-full">
                    <div className="bg-blue_gray-50_01 flex flex-col h-12 md:h-auto items-center justify-start px-4 py-3 rounded-[12px] w-full">
                      <Text
                        ...
                        size="txtMontserratRomanSemiBold15Bluegray90001"
                      >
                        Accra - Ghana
                      </Text>
                    </div>
            ...
            <div className="bg-white-A700 flex flex-row gap-2 items-center justify-end max-w-[647px] p-5 w-full">
              <Button
              ...
              <div className="bg-indigo-800 flex flex-col h-12 md:h-auto items-center justify-center px-5 py-3 rounded-[12px] w-[100px]">
                <Img
                  className="h-5 w-5"
...
export default BeneficiariesTwoPage;
