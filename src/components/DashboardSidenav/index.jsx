...
DashboardSidenav.defaultProps = {
  dashboardtext: "Transactions",
  dashboardonetext: "Insurance Policies",
  dashboardtwotext: "Beneficiaries",
  dashboardthreetext: "Settings",
};
